/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 207729d3368cb03c72e9ce11df1fc6b3)
// Runtime types generated with workerd@1.20260714.1 2026-07-16 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	ANALYSIS_AGGREGATE_LIMITER: RateLimit;
	ANALYSIS_CLIENT_LIMITER: RateLimit;
	REVISION_AGGREGATE_LIMITER: RateLimit;
	REVISION_CLIENT_LIMITER: RateLimit;
	ASSETS: Fetcher;
	MODELDUEL_TRUSTED_PROXY: "cloudflare";
	MODELDUEL_CLOUDFLARE_RATE_LIMITS: "enabled";
	MODELDUEL_REVISION_REPLAY: "durable-object";
	MODELDUEL_ANALYSIS_MODEL: "gpt-5.6-terra";
	MODELDUEL_REVISION_MODEL: "gpt-5.6-luna";
	OPENAI_API_KEY: string;
	MODELDUEL_EVALUATION_SECRET: string;
	REVISION_REPLAY_LEDGER: DurableObjectNamespace<import("./custom-worker").RevisionReplayLedger>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./custom-worker");
		durableNamespaces: "RevisionReplayLedger";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MODELDUEL_TRUSTED_PROXY" | "MODELDUEL_CLOUDFLARE_RATE_LIMITS" | "MODELDUEL_REVISION_REPLAY" | "MODELDUEL_ANALYSIS_MODEL" | "MODELDUEL_REVISION_MODEL" | "OPENAI_API_KEY" | "MODELDUEL_EVALUATION_SECRET">> {}
}

...
Historical post-merge `main` gate: **Complete for merge `6186358`**. The last recorded deployment evidence and latest video candidate both correspond to that merge. The release adds the compact teacher review, learner-controlled text handoff, copy/download boundary, safe text projection, and a video shot that shows the handoff before architecture.

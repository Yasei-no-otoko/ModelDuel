...
| Final merged release gate — `e5e7b03` | Frozen install; Node **356/356** across **34 files**; workerd **7/7**; Chromium **38/38**; Next.js/OpenNext/Workers types/Wrangler **Pass**; dry run **8,855.59 KiB raw / 1,705.90 KiB gzip**; production dependency audit **clean**; standard Codex Security scan **96/96 sources**, **0 reportable findings**. |
